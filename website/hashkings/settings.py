...
# ACCOUNTS_PROFILE_MODEL = "hashkings.ProfileModel"
...
ALLOWED_HOSTS = [
    ...
    '127.0.0.1:8000',
    'localhost',
    'hashkings-pro.us-west-2.elasticbeanstalk.com',
    'qwoyn.io',
    'hashkings.com',
]
...
SITE_ID = 1
SITE_TITLE = "hashkings.com"
SITE_TAGLINE = "Cultivating Geatness"
...
if os.environ['USER'] == 'ec2-user':
    DATABASES = {
        "default": {
            ...
            "HOST": "qdb.corr8ifrykl7.us-west-2.rds.amazonaws.com",
